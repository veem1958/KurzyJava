...
public class Kurzy {
	...
	/**
	 * Metóda umoòuje vygenerova a prideli kadému študentovi heslo.
	 * Nevyuíva sa - viï popis {@link Students#setPassword() setPassword} metódy. 
	 ...
	 * Nevyuíva sa - pozri {@linkplain Students#setPassword() setPassword} metódu.
	 */
